...
class Clavicle(gnModule.RigModule):
    def __init__(self,
                 side=None,
                 part=None,
                 guide_list=None,
    ...
    def output_rig(self):
        ...
        self.clav_chain = gnChain.Chain(transform_list=self.guide_list,
                                        prefix=self.side,
                                        suffix='driver_JNT',
                                        name=self.part)
        ...
        stretch = gnAttr.Attribute(node=self.main_ctrl.ctrl,
                                   type='double', value=0,
                                   min=0, max=1, keyable=True,
                                   name='stretch')
        twist = gnAttr.Attribute(node=self.main_ctrl.ctrl,
                                 type='double', value=0,
    ...
    def skeleton(self):
        bind_chain = gnChain.Chain(transform_list=self.clav_chain.joints,
                                   prefix=self.side,
                                   suffix='JNT',
                                   name=self.part)
