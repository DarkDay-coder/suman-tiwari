...
class Hip(gnModule.RigModule):
    ...
    def control_rig(self):
        # create controls
        self.hip_01 = gnCtrl.Control(parent=self.control_grp,
                                     shape='hip',
                                     prefix=self.side,
                                     suffix='CTRL',
                                     name=self.part + '_01',
        ...
        self.hip_02 = gnCtrl.Control(parent=self.hip_01.ctrl,
                                     shape='hip',
                                     prefix=self.side,
                                     suffix='CTRL',
                                     name=self.part + '_02',
    ...
    def skeleton(self):
        hip_chain = gnChain.Chain(transform_list=[self.hip_jnt],
                                  prefix=self.side,
                                  suffix='JNT',
                                  name=self.part)
