...
class Neck(gnModule.RigModule, gnSpline.Spline):
    def __init__(self,
                 side=None,
                 part=None,
                 guide_list=None,
    ...
    def skeleton(self):
        if self.fk_offset:
            ...
            neck_chain = gnChain.Chain(transform_list=fk_ctrls,
                                       prefix=self.side,
                                       suffix='JNT',
                                       name=self.part)
            ...
            neck_chain = gnChain.Chain(transform_list=self.spline_joints,
                                        prefix=self.side,
                                        suffix='JNT',
                                        name=self.part)
