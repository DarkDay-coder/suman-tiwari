...
class Chest(gnModule.RigModule):
    def __init__(self,
                 side=None,
                 part=None,
                 guide_list=None,
    ...
    def control_rig(self):
        # create controls
        self.chest_01 = gnCtrl.Control(parent=self.control_grp,
                                       shape='chest',
                                       prefix=self.side,
                                       suffix='CTRL',
                                       name=self.part + '_01',
        ...
        self.chest_02 = gnCtrl.Control(parent=self.chest_01.ctrl,
                                       shape='chest',
                                       prefix=self.side,
                                       suffix='CTRL',
                                       name=self.part + '_02',
    ...
    def skeleton(self):
        chest_chain = gnChain.Chain(transform_list=[self.chest_jnt],
                                    prefix=self.side,
                                    suffix='JNT',
                                    name=self.part)
