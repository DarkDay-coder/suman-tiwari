...
class Hand(gnModule.RigModule):
    ...
    def control_rig(self):
        # create controls
        self.hand_01 = gnCtrl.Control(parent=self.control_grp,
                                      shape='cube',
                                      prefix=self.side,
                                      suffix='CTRL',
                                      name=self.part + '_01',
        ...
        self.hand_02 = gnCtrl.Control(parent=self.hand_01.ctrl,
                                      shape='cube',
                                      prefix=self.side,
                                      suffix='CTRL',
                                      name=self.part + '_02',
        ...
        self.hand_local = gnCtrl.Control(parent=self.hand_02.ctrl,
                                         shape='arrowFourWay',
                                         prefix=self.side,
                                         suffix='CTRL',
        ...
        self.hand_fk = gnCtrl.Control(parent=self.control_grp,
    ...
    def output_rig(self):
        ...
        # create blend chain
        self.blend_chain = gnChain.Chain(transform_list=[ik_jnt],
                                         prefix=self.side,
                                         suffix='switch_JNT',
                                         name=self.part)
